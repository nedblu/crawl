...
;(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        serialize_params: function($w, wgd) {
            return {
                data_name: wgd.data_name,//data_name is a custom field that use to identify the element that i move or change by something like ID in DB
                col: wgd.col,
                row: wgd.row,
                size_x: wgd.size_x,
                size_y: wgd.size_y
    ...
    */
    fn.register_widget = function($el) {
        var wgd = {
            ...
            'el': $el,
            'data_name': $el.attr('data-name')//just an extra field that you could use to identify the widget taht you are work in, you could acceses via serialize_params method, its include that in a JSON format in a position 0 of the array
        };
